 ...
 * `process.env.EXPOSE_TEST_ROUTES === "1"` (originally introduced
 * alongside the now-retired Phase-03 stub probe module from Plan 03-07;
 * that probe was deleted in Plan 04-01 but the env-var gate pattern
 * remains). Production builds MUST leave the env var unset.
 *
