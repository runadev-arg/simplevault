...
export default function SecuritySettingsPage(): JSX.Element {
  ...
  // T2 + T3 import this from the page; using `void refresh` here to keep the
  // ref warm until the buttons land. Once they do, the enrol components
  // accept `onEnrolled={refresh}` — the call site is the same.
  void refresh;
    ...
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-6 px-6 py-10">
      ...
      <section className="flex flex-col gap-3 rounded-md border border-emerald-500/40 bg-emerald-500/5 p-5">
        ...
        <p className="text-sm italic text-zinc-500">
          Enrolment button is wired in the next commit (Plan 03-10 T2).
        </p>
      </section>
