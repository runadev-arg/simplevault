 ...
 * `./rendered-tiptap-html` (`<RenderedTipTapHtml>`), the single component in the
...
import { STRICT_EXTENSIONS } from "./extensions";

// Re-export the read-only HTML renderer so callers can import both the
// editor and the renderer from "./tiptap-editor".
export { RenderedTipTapHtml, sanitizeRenderedHtml } from "./rendered-tiptap-html";
